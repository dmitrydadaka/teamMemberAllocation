...
const GroupedTeamMember = ({ employees, selectedTeam, setTeam }) => {
    ...
    function groupTeamMembers() {
        ...
        let teamA = {
            team: 'TeamA', members: teamAMembers,
        ...
        let teamB = {
            team: 'TeamB', members: teamBMembers,
        ...
        let teamC = {
            team: 'TeamC', members: teamCMembers,
        ...
        let teamD = {
            team: 'TeamD', members: teamDMembers,
    ...
    function handleTeamClick(event) {
        let transformedGroupData = groupedEmployees.map(groupedData =>
            groupedData.team === event.currentTarget.id ? { ...groupedData, 
            collapsed: !groupedData.collapsed } : groupedData);
